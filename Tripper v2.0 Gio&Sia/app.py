...
'''
Per rimuovere tutti gli eventi con una certa destinazione
destinazione_da_rimuovere = "Roma, Lazio, Italia"
itinerary.update_many({},
    {
        "$pull": {
            "itinerary": {"destination": destinazione_da_rimuovere}
        }
    })
'''
